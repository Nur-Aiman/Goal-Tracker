...
<h1 className="text-4xl font-bold mb-4" onClick={navigateToHome} style={{ cursor: 'pointer', color: '#00ADB5' }}>
  Long Term <br /> Goals
</h1>
<div className="absolute top-8 right-8 flex flex-col space-y-4">
  <button
    className="bg-#00ADB5 hover:bg-#393E46 text-white font-bold py-2 px-4 rounded transition duration-300 ease-in-out"
