...
const { 
  addYear, addGoal, getYear, viewGoals, viewGoal, viewGoalsByYear, startGoal, currentGoals, postponeGoal, 
  addActivity, startActivity, currentActivities, postponeActivity, editGoal, deleteGoal, deleteActivity, 
  viewGoalsWithStartedActivitiesCount, completeActivity, completedActivities, updateScheduledStatus, completeGoal,
  getCompletedGoals
...
router.put('/completeGoal/:id', completeGoal); 
router.get('/completedGoals', getCompletedGoals);
